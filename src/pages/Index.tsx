  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-2xl mx-auto">
          ...
          <div className="flex space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-white mb-3">
                <p className="mb-4">MCP is an absolute game-changer.</p>
                <p className="mb-4">Yesterday, I taught a 2-hour session about MCP covering the following topics:</p>
                ...
                <p className="mb-3">Here is the full 2-hour video, free</p>
        ...
        <div className="border-b border-gray-800 px-4 py-3 hover:bg-gray-950/50 transition-colors cursor-pointer">
          <div className="flex space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-white mb-3">
                <p>Just shipped a new feature using the MCP protocol. The developer experience is incredible! 🚀</p>
              </div>
              <div className="flex items-center justify-between max-w-md text-gray-500">
                <button className="flex items-center space-x-2 hover:text-blue-400 transition-colors group">
                  <div className="p-2 rounded-full group-hover:bg-blue-400/10 transition-colors">
        ...
        <div className="border-b border-gray-800 px-4 py-3 hover:bg-gray-950/50 transition-colors cursor-pointer">
          <div className="flex space-x-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-500 to-blue-600 flex-shrink-0"></div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center space-x-1 mb-1">
                <span className="font-bold text-white">Tech News</span>
                <svg className="w-5 h-5 text-blue-400" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M22.46 6c-.77.35-1.6.58-2.46.69.88-.53 1.56-1.37 1.88-2.38-.83.5-1.75.85-2.72 1.05C18.37 4.5 17.26 4 16 4c-2.35 0-4.27 1.92-4.27 4.29 0 .34.04.67.11.98C8.28 9.09 5.11 7.38 3 4.79c-.37.63-.58 1.37-.58 2.15 0 1.49.75 2.81 1.91 3.56-.71 0-1.37-.2-1.95-.5v.03c0 2.08 1.48 3.82 3.44 4.21a4.22 4.22 0 0 1-1.93.07 4.28 4.28 0 0 0 4 2.98 8.521 8.521 0 0 1-5.33 1.84c-.34 0-.68-.02-1.02-.06C3.44 20.29 5.7 21 8.12 21 16 21 20.33 14.46 20.33 8.79c0-.19 0-.37-.01-.56.84-.6 1.56-1.36 2.14-2.23z"/>
                </svg>
                <span className="text-gray-500">@technews</span>
                <span className="text-gray-500">·</span>
                <span className="text-gray-500">1d</span>
              </div>
              <div className="text-white mb-3">
                <p>Breaking: New AI protocol revolutionizes how applications communicate. Early adopters report 10x improvement in development speed.</p>
              </div>
              <div className="flex items-center justify-between max-w-md text-gray-500">
                <button className="flex items-center space-x-2 hover:text-blue-400 transition-colors group">
                  <div className="p-2 rounded-full group-hover:bg-blue-400/10 transition-colors">
